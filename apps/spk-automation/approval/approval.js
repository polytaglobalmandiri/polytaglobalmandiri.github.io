(function(){
  ...
  function alertError(message){return Swal.fire({icon:'error',title:'Tidak berhasil',text:message||'Terjadi kesalahan.',confirmButtonColor:'#b41420'});}
