(function () {
  ...
  var EN = {
    ...
    "Nama aksesoris": "Accessory name",
    "Pilih UOM": "Select UOM",
    "+ Tambah Aksesoris": "+ Add Accessory",
    "Belum ada aksesoris untuk langkah ini.": "No accessories have been added for this stage.",
    "Tambahkan aksesoris, jumlah kebutuhan, dan UOM untuk langkah ini.": "Add accessories, required quantities, and UOMs for this stage.",
    "Isi nama aksesoris atau hapus baris yang tidak digunakan.": "Enter the accessory name or remove the unused row.",
    "Kebutuhan aksesoris harus lebih besar dari nol.": "The accessory requirement must be greater than zero.",
    "Pilih UOM untuk setiap aksesoris.": "Select a UOM for each accessory.",
    "PPIC": "PPIC Dashboard",
