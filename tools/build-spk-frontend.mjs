...
function convertTemplate(sourceName) {
  ...
  <style>
    .polyta-portal-home {
      ...
      color: #fff !important;
      background: linear-gradient(180deg, #e63b52, #c8102e 55%, #8a0b1f) !important;
      box-shadow: inset 0 1px 0 rgba(255,255,255,.42), 0 3px 8px rgba(38,8,14,.28) !important;
    }
    .polyta-portal-home:hover {
      filter: brightness(1.06);
      box-shadow: inset 0 1px 0 rgba(255,255,255,.5), 0 5px 12px rgba(38,8,14,.34) !important;
    }
  ...
  const navigationClass = sourceName === "FE-Dashboard.html"
    ...
    : sourceName === "FE-Keluar-Bahan.html"
      ...
      : sourceName === "FE-Cetak-SPK.html"
        ...
        : "app-nav-link";
  const portalHomeButton = `<a class="${navigationClass} polyta-portal-home no-print" href="/" title="Kembali ke portal utama">
